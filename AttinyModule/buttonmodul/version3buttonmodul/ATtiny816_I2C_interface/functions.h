...
void initSensorStates() {
  last_digital_1 = digitalRead(DIGITAL_PIN_1);
  last_digital_2 = digitalRead(DIGITAL_PIN_2);
  last_digital_3 = digitalRead(DIGITAL_PIN_3);
  last_digital_4 = digitalRead(DIGITAL_PIN_4);
  last_digital_5 = digitalRead(DIGITAL_PIN_5);
  last_digital_6 = digitalRead(DIGITAL_PIN_6);
...
void updateSensorStates() {
  ...
  // Digital Pin 1
  uint8_t d1 = digitalRead(DIGITAL_PIN_1);
  ...
  // Digital Pin 2
  uint8_t d2 = digitalRead(DIGITAL_PIN_2);
  ...
  // Digital Pin 3
  uint8_t d3 = digitalRead(DIGITAL_PIN_3);
  ...
  // Digital Pin 4
  uint8_t d4 = digitalRead(DIGITAL_PIN_4);
  ...
  // Digital Pin 5
  uint8_t d5 = digitalRead(DIGITAL_PIN_5);
  ...
  // Digital Pin 6
  uint8_t d6 = digitalRead(DIGITAL_PIN_6);
