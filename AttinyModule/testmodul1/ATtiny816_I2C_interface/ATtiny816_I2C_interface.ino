...
#define MODULE_TYPE_ID 07  // kann an sich wegkommen aber passt schon
#define PIN_ENABLE_L 12
...
#define DIGITAL_PIN_2 5

#define LED_PIN 1  // Deine LED an Pin 1
